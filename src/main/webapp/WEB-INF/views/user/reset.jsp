...
<div id="global">
    ...
    <form:errors path="rp" cssClass="alert-danger"/>
    <form:form method="post" action="${pageContext.request.contextPath}/validatePassword" modelAttribute="rp" >
        ...
        <div class="form-group">
            ...
            <form:input path="repeatedPassword" cssClass="form-control"  type="password" placeholder="repeat your password" />
