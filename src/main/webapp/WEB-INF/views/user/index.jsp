...
<div id="global">
    ...
    <form:form method="post" action="${pageContext.request.contextPath}/login" modelAttribute="user" >
        ...
        Don't have an account <a href="${pageContext.request.contextPath}/signUp"> click here  </a>
    </form:form>
    You forgot your password <a href="${pageContext.request.contextPath}/sendCode"> click here  </a>
